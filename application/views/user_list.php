                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        <td align="center">
                                            <a href="<?php echo base_url('admin/deleteuser/').$value->id_user; ?>" class="btn btn-xs btn-danger"><i class="fa fa-remove"></i></a>
                                        </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                </table>
                                <a href="<?php echo base_url('admin/registeradmin/')?>" class="btn btn-xs btn-danger">Daftar User Baru</a>
                            </div>
                        </div>
                    </div>
                </div>
