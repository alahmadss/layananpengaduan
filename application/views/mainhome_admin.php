...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Halaman Beranda</h4> </div>
                ...
                <!-- row -->
                <?php 
                $datalapor = $this->modelpengaduan->listpengaduan()->num_rows();
                $datauser = $this->modelpengaduan->listuser()->num_rows();
                ?>
                <div class="row">
                    <!--col -->
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                    <h5 class="text-muted vb">Jumlah Laporan</h5> </div>
    ...
    $(document).ready(function() {
        $.toast({
            heading: 'Selamat Datang, <?php echo $this->session->userdata('ses_username') ?>',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
