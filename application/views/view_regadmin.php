        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<?php echo base_url('admin/regsimpan')?>" method="post">
                                <div class="form-group">
                                    <label class="col-md-12">Id User</label>
                                    <div class="col-md-12">
                                            <?php $iduser = date("ymd").rand(0000,9999);?>
                                        <input type="text" value="<?php echo $iduser?>" class="form-control form-control-line" disabled> 
                                        <input type="hidden" value="<?php echo $iduser?>" class="form-control form-control-line" name="iduser">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="nama"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control form-control-line" name="telp">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Level User</label>
                                    <div class="col-md-6">
